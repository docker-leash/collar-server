...
version = None
with io.open('docker_collar/collar_client.py', 'rt', encoding='utf8') as fobj:
    version = re.search(
...
_github_path = 'docker-leash/collar-client'
...
setup(
    ...
    description='Docker authorization plugin collar',
